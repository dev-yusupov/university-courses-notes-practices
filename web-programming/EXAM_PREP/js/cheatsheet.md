...
**Most Used Array Methods:** filter, map, find, reduce, sort  
**Most Common Events:** click, submit, input, change  
**Canvas Full Circle:** Math.PI * 2  
**Fetch Patterns:** Always use .then() or async/await, never forget .json()  
**Form Validation:** Use setCustomValidity() for custom error messages
